...
<div id="list-empresa" class="content scaffold-list" role="main">
  ...
  <table>
    ...
    <g:sortableColumn property="administrativos" title="${message(code: 'empresa.administrativos.label', default: 'Administrativos')}" />

   <g:sortableColumn property="obreros" title="${message(code: 'empresa.obreros.label', default: 'Obreros')}" />
    ...
    <g:each in="${empresaInstanceList}" status="i" var="empresaInstance">
      ...
      <td>${fieldValue(bean: empresaInstance, field: "administrativos")}</td>

      

      <td>${fieldValue(bean: empresaInstance, field: "obreros")}</td>
