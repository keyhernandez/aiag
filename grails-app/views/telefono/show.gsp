	...
	<body>
		...
		<div id="show-telefono" class="content scaffold-show" role="main">
			...
			<ol class="property-list telefono">
				...
				<g:if test="${telefonoInstance?.phone}">
				<li class="fieldcontain">
					<span id="phone-label" class="property-label"><g:message code="telefono.phone.label" default="Phone" /></span>
					
						<span class="property-value" aria-labelledby="phone-label"><g:fieldValue bean="${telefonoInstance}" field="phone"/></span>
