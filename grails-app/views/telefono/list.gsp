			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="phone" title="${message(code: 'telefono.phone.label', default: 'Phone')}" />
				...
				<g:each in="${telefonoInstanceList}" status="i" var="telefonoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${telefonoInstance.id}">${fieldValue(bean: telefonoInstance, field: "phone")}</g:link></td>
