...
<body>
  ...
  <div class="nav1" role="navigation">
    <ul>
      ...
      <sec:ifAnyGranted roles="ROLE_ADMIN"><li><a class="list" href="${createLink(controller:'SecUser',action:'index')}">Usuarios</a></li></sec:ifAnyGranted>
      <sec:ifAnyGranted roles="ROLE_ADMIN"><li><a class="list" href="${createLink(controller:'SecRole',action:'index')}">Roles</a></li></sec:ifAnyGranted>
