...
<body>
  ...
  <div class="nav1" role="navigation">
    <ul>
      ...
      <sec:ifAnyGranted roles="ROLE_SUPERUSER"><li><a class="list" href="${createLink(controller:'TipoEmpresa',action:'index')}">Tipo de Empresa</a></li></sec:ifAnyGranted>
      <sec:ifAnyGranted roles="ROLE_SUPERUSER"><li><a class="list" href="${createLink(controller:'Persona',action:'index')}">Personas Contacto</a></li></sec:ifAnyGranted>
      ...
      <sec:ifAnyGranted roles="ROLE_ADMIN"><li><a class="list" href="${createLink(controller:'TipoEmpresa',action:'index')}">Tipo de Empresa</a></li></sec:ifAnyGranted>
      <sec:ifAnyGranted roles="ROLE_ADMIN"><li><a class="list" href="${createLink(controller:'Cargo',action:'index')}">Personas Contacto</a></li></sec:ifAnyGranted>
